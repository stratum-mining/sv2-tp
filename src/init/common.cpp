...
void AddLoggingArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-printtoconsole", "Send trace/debug info to console (default: 1). To disable logging to file, set -debuglogfile=0", ArgsManager::ALLOW_ANY, OptionsCategory::DEBUG_TEST);
